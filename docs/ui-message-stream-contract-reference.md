...
Defines the wire contract between ai-go backends and AI SDK Node v5 / Swift clients.
...
| AI SDK Node v5 type       | ai-go constant              | Notes                                               |
|---------------------------|-----------------------------|-----------------------------------------------------|
...
| `tool-input-start`        | `ChunkToolInputStart`       | Carries `toolCallId`, `toolName`                    |
| `tool-input-delta`        | `ChunkToolInputDelta`       | Carries `toolCallId`, `inputTextDelta`              |
| `tool-input-available`    | `ChunkToolInputAvailable`   | Carries `toolCallId`, `toolName`, `input`           |
| `tool-output-available`   | `ChunkToolOutputAvailable`  | Carries `toolCallId`, `output`, optional `providerMetadata` |
| `tool-input-error`        | `ChunkToolInputError`       | Carries `toolCallId`, `toolName`, `input`, `errorText` |
| `tool-output-error`       | `ChunkToolOutputError`      | Carries `toolCallId`, `errorText`                   |
| `tool-output-denied`      | `ChunkToolOutputDenied`     | Carries `toolCallId`                                |
...
| `source-document`         | `ChunkSourceDocument`       | Carries `sourceId`, `mediaType`, `title`, `filename`|
| `message-metadata`        | `ChunkMessageMetadata`      | Carries `messageMetadata`                           |
| `abort`                   | `ChunkAbort`                | Carries optional `reason`                           |
| `file`                    | `ChunkFile`                 | Carries `url`, `mediaType`                          |
...
## Intentional Differences from AI SDK Node v5

| Topic | Node v5 | ai-go | Reason |
|-------|---------|-------|--------|
...
wr.WriteToolOutputError("tc-123", "connection timeout")
